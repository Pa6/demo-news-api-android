...
public class NewsFragment extends Fragment implements NewsAdapter.OnArticleClickListener{
        ...
        {
                Toast.makeText(NewsFragment.this.getContext(), "you selected "+ source_article+" and "+ category_article, Toast.LENGTH_SHORT).show();
                Log.d("getAllArticles","getAllArticles");
